...
fun HomeScreen(onButtonClick: () -> Unit) {
    ...
    LaunchedEffect(Unit) {
        val token = "Bearer BQAPLgx1d8ynA4_yQlnthxTNQosZ3KrCL9f3-LrIaQLHLcuDB96ibTmffN8eWcbGOmk4SHbj-1HityEheQoHCitQPdODch6uITl6yLpgZiq3OmiaBgc" // Replace with your actual token
